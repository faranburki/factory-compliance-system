"""Panel cover detector for identifying open electrical panels.

Class 2 — Opened Panel Cover: A state-based check that uses the Groq
vision API to classify whether an electrical panel cover is open or closed
